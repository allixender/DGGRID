...
////////////////////////////////////////////////////////////////////////////////
const char *DgZ3RF::str2add(DgZ3Coord *add, const char *str,
...
////////////////////////////////////////////////////////////////////////////////
string DgZ3Coord::valString(void) const {
...
DgZ3StringtoZ3Converter::DgZ3StringtoZ3Converter(
    ...
    : DgConverter<DgZ3StringCoord, long long int, DgZ3Coord, long long int>(
          from, to) {
  ...
  if (!zsRF) {
    report("DgZ3StringtoZ3Converter::DgZ3StringtoZ3Converter(): "
           " fromFrame not of type DgZ3StringRF",
           DgBase::Fatal);
  }
...
DgZ3ToZ3StringConverter::DgZ3ToZ3StringConverter(
  ...
  if (!zsRF) {
    report("DgZ3ToZ3StringConverter::DgZ3ToZ3StringConverter(): "
           " toFrame not of type DgZ3StringRF",
           DgBase::Fatal);
  }
